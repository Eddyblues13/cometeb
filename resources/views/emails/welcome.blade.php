...
<head>
	...
	<title>Commercial Trade Equity Bank</title>
			...
			<tbody>
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<h2>Welcome to Commercial Trade Equity Bank</h2>
						<br>
						<br>
						<p style='line-height: 24px;margin-bottom:15px;'>
							Thanks for joining Commercial Trade Equity Bank as your new home. We're excited to have you
							on
							board!
						</p>
						<p style='line-height: 24px;margin-bottom:15px;'>
				...
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						<h3>Kind Regards,</h3>
						<p>Commercial Trade Equity Bank</p>
					</td>
				</tr>
				...
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<center>
							<span style="color: #706d6b"> © 2024 Commercial Trade Equity Bank</span>
						</center>
