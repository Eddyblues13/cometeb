...
<head>
    ...
    <meta name="author" content="Commercial Trade Equity Bank">
    <meta name="robots" content="noindex, nofollow">

    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Commercial Trade Equity Bank : ">
    <meta property="og:title" content="Commercial Trade Equity Bank : ">
    <meta property="og:description" content="Commercial Trade Equity Bank : ">
    <meta property="og:image" content="admin71.Linit Wavetb.com/images/favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>Commercial Trade Equity Bank - Dashboard</title>
    <!-- Favicon icon -->
    ...
    <script src="//code.tidio.co/mxdceyzorunb7mphvfthhncgaj0tmzfs.js" async></script>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('dashboard')}}" class="brand-logo">
                ...
                <img style="height: 30px; width:50px" src="{{asset('asset/img/logo.png')}}" alt="">
            </a>
